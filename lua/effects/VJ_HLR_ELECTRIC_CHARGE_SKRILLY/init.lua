...
function EFFECT:Render()
	...
	render.DrawBeam(self.StartPos, self.EndPos, math.Rand(18,24), math.Rand(0,1), math.Rand(0,1) + ((self.StartPos - self.EndPos):Length() / 128), Color(0, 225, 225, 150 / ((self.DieTime - 0.5) - CurTime())))
end